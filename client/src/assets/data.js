...
export const blogs = [
  {
    title: "Les 10 meilleures villes pour louer une voiture en 2025",
    category: "Tendances Voyage",
    image: blog1,
    description:
      "Découvrez les meilleures villes où la location de voiture est abordable, pratique et offre la meilleure expérience de voyage en 2025.",
  },
  {
    title: "Comment choisir la bonne voiture de location",
    category: "Guide de Location",
    image: blog2,
    description:
      "Un guide étape par étape pour sélectionner la voiture de location parfaite en fonction de votre budget, du type de voyage et de vos préférences.",
  },
  {
    title: "Voitures de luxe vs économiques : laquelle louer ?",
    category: "Comparaisons de Voitures",
    image: blog3,
    description:
      "Explorez les avantages de la location de voitures de luxe par rapport aux options économiques et décidez ce qui convient le mieux à votre voyage.",
  },
  {
    title: "Conseils essentiels pour la première location de voiture",
    category: "Conseils Débutants",
    image: blog4,
    description:
      "Des conseils essentiels pour les locataires novices pour éviter les frais cachés, choisir la bonne assurance et obtenir les meilleures offres.",
  },
  {
    title: "Maximiser les économies sur les locations longue durée",
    category: "Économies d'Argent",
    image: blog5,
    description:
      "Découvrez des stratégies intelligentes pour économiser et obtenir la meilleure valeur lors de la location de voitures pour des durées plus longues.",
  },
  {
    title: "Conduite personnelle vs voitures avec chauffeur : lequel est meilleur ?",
    category: "Choix de Voyage",
    image: blog6,
    description:
      "Comprenez les avantages et les inconvénients de la location d'une voiture de conduite personnelle par rapport à l'embauche d'un service avec chauffeur.",
  },
  {
    title: "Comment réserver une voiture pour un road trip",
    category: "Guide Road Trip",
    image: blog7,
    description:
      "Apprenez à planifier et réserver la bonne voiture pour rendre vos road trips sûrs, confortables et agréables.",
  },
  {
    title: "Tendances de l'industrie de la location de voitures en 2025",
    category: "Tendances du Marché",
    image: blog8,
    description:
      "Un aperçu expert des dernières tendances du marché de la location de voitures, des véhicules électriques aux modèles de location flexibles.",
  },
];
